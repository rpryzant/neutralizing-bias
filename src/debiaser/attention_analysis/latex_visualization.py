...
def generate(text_list, attention_list, latex_file, color='red', rescale_value = True):
	...
	attention_list = [float(format(num, '.4f')) for num in attention_list]
...
if __name__ == '__main__':
        ...
        for i,result in enumerate(results):
                ...
                attention = [float(num) for num in result['attention_dist']]
                color = 'red'
                generate(words, attention, "tex_files/sample_{}.tex".format(i), color)
